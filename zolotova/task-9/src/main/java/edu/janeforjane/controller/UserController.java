...
//    private static final Logger log = LoggerFactory.getLogger(UserController.class);
    ...
    public ResponseEntity<String> registerUser(@RequestParam String login, @RequestParam String password) throws Exception {
        log.info("Got request for registration");
        try {
//            userService.registerUser(login, password);
            userService.registerUserWithLock(login, password);
