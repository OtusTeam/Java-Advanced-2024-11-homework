...
public class UserServiceImpl implements UserService{
    ...
    public void registerUser(String login, String password) throws LoginAlreadyExistsException, UnableSaveDataException, InterruptedException {

//        wasteCpu();// reason of cpu wasting
...
//        cachedUsers.add(input_user);
        ...
        try {
            ...
            log.error("Something goes wrong with saving");
