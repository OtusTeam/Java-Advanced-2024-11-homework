...
public class JMeterLoadTest {
    ...
    private static void runJMeterTest() throws IOException {
        ...
        resultCollector.setFilename("terentev/hw08-jmeter/jmeter-results.jtl");
        testPlanTree.add(testPlanTree.getArray()[0], resultCollector);

        SaveService.saveTree(testPlanTree, new FileOutputStream("terentev/hw08-jmeter/jmeter-script.jmx"));
