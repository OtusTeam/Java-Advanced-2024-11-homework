...
## Цель: Реализовать сервис (Rest или gRPC) защиту от ошибок с использованием CircuitBreaker и с защитой от перегрузки (RateLimiter)
1. Создать новый Rest или gRPC сервис
2. Добавить в контроллер метод получения возраста пользователя по его id
